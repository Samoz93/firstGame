...
//   final room;
//   GamerPageVM({this.room}) {
//     setAnim(GDirections.None);
//     _gSer = GameService(gameUid: room['uid'], player2Uid: room['p2']);
//   }
//   GameService _gSer;
//   Timer gameTimer;
//   Timer secondTimer;
...
//   Stream<GDirections> get player2Stream {
//     return _gSer.player2Data.map((event) {
//       final lastDirIndex = event[activePhase.phase - 1];
//       if (lastDirIndex != null)
//         return GDirections.values
//             .firstWhere((element) => element.index == lastDirIndex);
//     });
//   }
